			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<c:if test="${authDTO == null}"><li class="nav-item">
							...
							<c:if test="${authDTO != null}">
								...
								<li class="nav-item">
								<li class="nav-item"><a class="nav-link" href='<c:url value="/member/changePwd"  />'>비밀번호변경</a>
								</li>
								<li class="nav-item">
								<li class="nav-item"><a class="nav-link" href='<c:url value="/member/leave"  />'>회원탈퇴</a>
								</li>
							<li class="nav-item">
