...
<form action='<c:url value='/update.do'/>' method="post">
	...
	<div class="mb-3">
		...
		<input type="text" class="form-control" id="price" name="price" value="현제가격 : ${dto.price }" readonly>
		<input type="text" class="form-control" id="newprice" name="newprice" placeholder="수정할 가격">
	</div>
	<div class="mb-3">
