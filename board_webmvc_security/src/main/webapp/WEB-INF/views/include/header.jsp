                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">손님</span>
                                </security:authorize>                                
                                <security:authorize access="isAuthenticated()">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><security:authentication property="principal.memberDTO.username"/><strong>님</strong></span>
                                </security:authorize>                                
