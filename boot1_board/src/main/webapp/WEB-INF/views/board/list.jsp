...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">게시판 목록</h1>
</div>
<div class="d-flex">
	<!-- 검색시작 -->
	...
	<div class="pb-2">
		<button class="btn btn-xs btn-success" type="button" onclick="location.href='/board/register'">새 글 등록</button>
	</div>
</div>
...
<nav aria-label="...">
	<ul class="pagination justify-content-center">
		...
		<li class="page-item">
			<a class="page-link" href="/board/list?page=1&amount=${cri.amount }">처음으로</a>
		</li>
