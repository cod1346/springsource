...
import com.example.restaurant.wishList.repository.WishListReposiroty;
...
public class WishListServiceImpl implements WishListService {
	...
	@Autowired
	private WishListReposiroty wishListReposiroty;
	...
	public WishListDTO add(WishListDTO wishListDTO) {
		...
		WishListEntity saveEntity = wishListReposiroty.save(entity);
