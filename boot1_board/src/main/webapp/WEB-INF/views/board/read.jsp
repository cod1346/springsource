...
<div class="row">
	<div class="col">
		<form action="/board/register" method="post">
		  ...
		  <!-- 로그인 상황에서 해당 개시물 작성자와 동일할 때만 보여주기 -->
			...
			<div class="form-row">
				...
				<div class="col my-2">
					<div class="form-row my-2">
						<input type="text" name="replyer" id="replyer1" class="form-control" value='<security:authentication property="principal.username"/>' readonly/>
					</div>
					<div class="form-row my-2">
...
<button type="button" id="tete">ddddd</button>
<!-- 댓글 수정 폼 종료-->
